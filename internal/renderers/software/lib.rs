...
impl<'a, T: ProcessScene> SceneBuilder<'a, T> {
    ...
    fn draw_text_bitmap_to_cache(
        ...
        use i_slint_core::graphics::AlphaOnly;
    ...
    fn render_text_to_alpha_map<Font>(
        ...
        layout: i_slint_core::textlayout::TextLayout<'_, Font>,
    ) -> SharedPixelBuffer<i_slint_core::graphics::AlphaOnly>
    where
        Font: AbstractFont
            + i_slint_core::textlayout::TextShaper<Length = PhysicalLength>
            + GlyphRenderer,
    {
        ...
        let text_color = i_slint_core::graphics::Color::from_argb_u8(255, 0, 0, 0);
...
impl<T: ProcessScene> i_slint_core::item_rendering::ItemRenderer for SceneBuilder<'_, T> {
    ...
    fn draw_text(
        ...
        let string = match &content {
            PlainOrStyledText::Plain(string) => string.clone(),
            PlainOrStyledText::Styled(styled_text) => {
                i_slint_core::styled_text::get_raw_text(styled_text).as_ref().into()
            }
        };
...
mod paragraph_cache {
    ...
    impl ParagraphCacheKey {
        ...
        pub fn new(
            ...
            let i_slint_core::item_rendering::PlainOrStyledText::Plain(string) = text.text() else {
                return None;
            };
